...
if USE_SIMU_DATA:
    ...
    exp_res_path = "20180622_3body.txt"
...
def keep_valid_events(X1, Y1, X2, Y2, dT12, dT13):

    (t1_1, t1_2, t1_3) = t1_roots(dT12, dT13)
...
def ker_of_gen_noise(X1, X2, Y1, Y2, dT12, dT13):
    ...
    (X1vs1,Y1vs1,X2vs1,Y2vs1,X3vs1,Y3vs1,dT12vs1,dT13vs1,t1vs1) = keep_valid_events(n_X1, n_Y1, n_X2, n_Y2, n_dT12, n_dT13)
